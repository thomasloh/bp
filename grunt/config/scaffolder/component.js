...
// Grab imports
var componentJsTemplatePath = __dirname + '/templates/component.tpl.js';
...
module.exports = function() {
  ...
  var jsFilename = prepareFileName(name, '.js');
  ...
  // Prepare class name
  var className = prepareClassName(name);
